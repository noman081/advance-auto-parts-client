        ...
        <div>
            <header class="max-h-full bg-white p-6 grid">
                ...
                <div class="container mx-auto mt-8 md:mt-0 md:space-x-10 md:grid grid-cols-3 justify-center md:py-40">
                    <div class="grid justify-center items-center order-1 col-span-1">
                        <img class="lg:h-80 md:h-64 h-40 rounded" src="https://i.ibb.co/FXxLff3/IMG-20211003-150038-min.jpg" alt="" />
                    </div>
                    <div class="mt-8 md:mt-0 lg:justify-end col-span-2">
                        <h1 class="text-4xl text-gray-800 text-center md:text-left font-bold mb-6">Hi, I am Abdullah Al Noman, <br />Full Stack Developer</h1>
                        <p class="text-xl text-gray-800 text-center md:text-left">Seeking a responsible position with a turbulent and dynamic organization that offers
            ...
            <div class="md:gap-4 p-6 bg-blue-50 md:grid">
                <div class="grid grid-cols-2 justify-between lg:px-40 md:mb-4">
                    <h1 class="justify-start md:text-left text-2xl font-bold">Skills</h1>
                </div>
                <div class="md:grid grid-cols-2 gap-6 lg:px-40">
                    <div>
                        <div class="bg-white p-4">
                            <div>
                                <div class="mb-4">
                                    <h1 class="text-2xl text-gray-700">Currently Working With</h1>
                                </div>
                    ...
                    <div class="bg-white p-4 md:mt-0 mt-6">
                        <div>
                            <div class="mb-4">
                                <h1 class="text-2xl text-gray-700">Familiar With</h1>
                            </div>
                ...
                <div class="mt-6 p-4 bg-white px-6">
                    <div class="border-b pb-6">
                        <h1 class="mt-2 mb-6 text-center text-3xl font-bold">Projects</h1>
                        <div class="md:grid grid-cols-2 gap-6 my-5 items-center">
                            <div>
                                <img class="md:h-full object-cover" src={pic1} alt="" />
                            </div>
                            <div>
                                <h1 class="my-6 text-2xl font-bold text-gray-700">CarMax Warehouse</h1>
                                <a href='https://carmax-warehouse.web.app/' target='_blank' class="text-lg mr-4 py-1 px-4 rounded-full bg-gray-800 text-white">Livesite</a>
                        ...
                        <div class="md:grid grid-cols-2 gap-6 my-5 items-center">
                            <div>
                                <img class="md:h-full object-cover" src={pic2} alt="" />
                            </div>
                            <div>
                                <h1 class="my-6 text-2xl font-bold text-gray-700">Dream Photography</h1>
                                <a href='https://dream-photography.web.app/' target='_blank' class="text-lg mr-4 py-1 px-4 rounded-full bg-gray-800 text-white">Livesite</a>
                                <spnan class="text-lg">Dashboard</spnan>
                        ...
                        <div class="md:grid grid-cols-2 gap-6 my-5 items-center">
                            <div>
                                <img class="md:h-full object-cover" src={pic3} alt="" />
                            </div>
                            <div>
                                <h1 class="my-6 text-2xl font-bold text-gray-700">PS5 Mania</h1>
                                <a href='https://ps5-mania-noman.netlify.app/' target='_blank' class="text-lg mr-4 py-1 px-4 rounded-full bg-gray-800 text-white">Livesite</a>
                                <spnan class="text-lg">Dashboard</spnan>
            ...
            <section class="px-20 mt-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-6 my-10">
                    <div class="flex flex-col col-span-2 mb-4 md:mb-0">
                        ...
                        <h6 class="text-lg font-bold">University of Asia Pacific</h6>
